		...
		<div className="w-full max-w-4xl mx-auto p-6 bg-white">
			...
			<div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
				...
				<ul className="space-y-2 text-sm">
					<li>
						<strong>24V ON:</strong> Current flows through LED →
						Phototransistor conducts → 5V OUT pulled LOW (~0V)
					</li>
					<li>
						<strong>24V OFF:</strong> No LED current → Phototransistor off
						→ 5V OUT pulled HIGH (5V) by R2
					</li>
					<li>
						<strong>Isolation:</strong> 2.5kV typical between input and
						output sides
					</li>
					<li>
						<strong>Response time:</strong> ~4µs typical (adequate for
			...
			<div className="mt-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
				...
				<ul className="space-y-2 text-sm">
					...
					<li>
						<strong>R2 value:</strong> Can be adjusted based on load.
						Lower = faster rise time, higher current
					</li>
					<li>
					...
					<li>
						<strong>PCB layout:</strong> Keep 24V and 5V sections
						separated for isolation
					</li>
				</ul>
			</div>
		</div>
